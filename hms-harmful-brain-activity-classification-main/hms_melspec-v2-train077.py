...
class CFG:
    ...
    model_name = "tf_efficientnet_b2_ap"  # tf_efficientnet_b5 tf_efficientnet_b2_ap tf_efficientnetv2_s.in1k
    max_len = 512
    in_channels = 3
    head_dropout = 0.2
...
def main():
    ...
    all_eegs = np.load(f"{DATA}/eeg_spectrograms/eeg_inverse_256x512.npy", allow_pickle=True).item()
